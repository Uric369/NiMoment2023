...
const Combination = ({ icon, text1, text2, count , sequence}) => {
  return (
    <div style={{ display: 'flex', alignItems: 'flex-end', marginBottom: '2vh' }}>
      {sequence === "left" && icon && <img src={icon} alt="Icon" style={{ marginRight: '10px', width: '6vh', height: "6vh" }} />}
      ...
      {sequence === "right" && icon && <img src={icon} alt="Icon" style={{ marginRight: '10px', width: '6vh', height: "6vh" }} />}
    </div>
  );
};
