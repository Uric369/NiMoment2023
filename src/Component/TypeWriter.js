...
class Typewriter extends Component {
    ...
    this.interval = setInterval(() => {
      if (this.currentIndex < originalText1.length + originalText2.length - 2) {
        ...
        this.setState((prevState) => ({
          text1: prevState.text1.slice(0, -1) + originalText1[this.currentIndex] + '▊',
        }));
        this.currentIndex++;
    }
    else {
        ...
        this.setState((prevState) => ({
            ...
            text2: prevState.text2.slice(0, -1) + originalText2[this.currentIndex - originalText1.length] + '▊',
          }));
          this.currentIndex++;
        }
        else {
  ...
  render() {
    return(
    <div>
        <audio src={typeSound} controls autoPlay loop style={{ position: 'fixed', top: '-1000px' }}/>    
