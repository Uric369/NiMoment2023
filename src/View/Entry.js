...
function Entry() {
  ...
  return (
    ...
    <div className="container">
      <ul ref={sceneRef}>
        <li className="layer" data-depth=".2"><img src={planet1} alt="" /></li>
        <li className="layer" data-depth=".3"><img src={planet2} alt="" /></li>
        <li className="layer" data-depth=".2"><img src={man} alt="" /></li>
        <li className="layer" data-depth=".5"><img src={earth} alt="" /></li>
        <li className="layer" data-depth=".1"><img src={NiMoment} alt="" /></li>
        <li className="layer" data-depth=".4"><img src={planet3} alt="" /></li>
        <li className="layer" data-depth=".8"><img src={planet4} alt="" /></li>
        <li className="layer" data-depth="0"><img src={rocket} alt="" /></li>
      </ul>
    </div>
    {animateText ? (
          <Typewriter originalText1={`>> Authenticating... DONE`} 
